...
void Scene::InitialiseWater(Water& water, boost::property_tree::ptree::iterator& it)
{
    ...
    water.deepColour = GetValue<float>(it, "DeepColour");
    water.shallowColour = GetValue<float>(it, "ShallowColour");
                           ...
                           boost::property_tree::ptree& entry)
{
    ...
    entry.add("DeepColour", water.deepColour);
    entry.add("ShallowColour", water.shallowColour);
