...
struct qt_meta_stringdata_Tweakable_t {
    QByteArrayData data[5];
    char stringdata[39];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Tweakable_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Tweakable_t qt_meta_stringdata_Tweakable = {
    {
...
QT_MOC_LITERAL(4, 29, 9)
    ...
    "Tweakable\0UpdateValue\0\0value\0DialValue"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Tweakable[] = {
...
void Tweakable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Tweakable *_t = static_cast<Tweakable *>(_o);
        switch (_id) {
...
const QMetaObject Tweakable::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Tweakable.data,
      qt_meta_data_Tweakable,  qt_static_metacall, 0, 0}
};


const QMetaObject *Tweakable::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *Tweakable::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Tweakable.stringdata))
        return static_cast<void*>(const_cast< Tweakable*>(this));
    return QWidget::qt_metacast(_clname);
}

int Tweakable::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
