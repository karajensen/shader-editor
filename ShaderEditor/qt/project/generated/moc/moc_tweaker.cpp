...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Tweaker_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Tweaker_t qt_meta_stringdata_Tweaker = {
    {
QT_MOC_LITERAL(0, 0, 7) // "Tweaker"
...
QT_INIT_METAOBJECT const QMetaObject Tweaker::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Tweaker.data,
    qt_meta_data_Tweaker,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Tweaker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Tweaker.stringdata0))
